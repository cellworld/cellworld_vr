...
// https://github.com/Corysia/VR_Lab/blob/main/Source/VR_Lab/Private/DesktopCharacter.cpp
...
DEFINE_LOG_CATEGORY(LogPlayerCharacterDesktop);

//////////////////////////////////////////////////////////////////////////
// APlayerCharacterDesktop
 ...
 */
APlayerCharacterDesktop::APlayerCharacterDesktop() {
 ...
 */
void APlayerCharacterDesktop::BeginPlay()
{
    // Call the base class
    Super::BeginPlay();
 ...
 */
void APlayerCharacterDesktop::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    // Add Input Mapping Context
    ...
    else
    {
        ...
        // message.
        UE_LOG(LogPlayerCharacterDesktop,
               Error,
               TEXT(
 ...
 */
void APlayerCharacterDesktop::Move(const FInputActionValue& Value)
{
    // input is a Vector2D
 ...
 */
void APlayerCharacterDesktop::Look(const FInputActionValue& Value)
{
    // input is a Vector2D
...
void APlayerCharacterDesktop::BoomZoom(const FInputActionValue& Value)
{
 ...
 */
bool APlayerCharacterDesktop::IsInFirstPerson() const
{
 ...
 */
void APlayerCharacterDesktop::TogglePerspective()
{
    if (!HasAuthority())
    {
        // If we are on the client, we need to call the server function
        // to perform the actual toggling
        UE_LOG(LogPlayerCharacterDesktop, Verbose, TEXT("Client_TogglePerspective"))
    ...
    else
    {
        ...
        if (IsInFirstPerson())
        {
            UE_LOG(LogPlayerCharacterDesktop, Verbose, TEXT("Switching to third person"))
        ...
        {
            UE_LOG(LogPlayerCharacterDesktop, Verbose, TEXT("Switching to first person"))
 ...
 */
void APlayerCharacterDesktop::Server_TogglePerspective_Implementation()
{
    UE_LOG(LogPlayerCharacterDesktop, Verbose, TEXT("Server_TogglePerspective_Implementation"));
    TogglePerspective();
}
 ...
 */
bool APlayerCharacterDesktop::Server_TogglePerspective_Validate()
{
    UE_LOG(LogPlayerCharacterDesktop, Verbose, TEXT("Server_TogglePerspective_Validate"));
    return true;
}