...
#include "PlayerCharacterDesktop.generated.h"
...
DECLARE_LOG_CATEGORY_EXTERN(LogPlayerCharacterDesktop, Log, All);

UCLASS(config = Game)
class APlayerCharacterDesktop : public ACharacter
{
    GENERATED_BODY()
