...
typedef enum XrStructureType {
    ...
    XR_TYPE_PATHS_FOR_INTERACTION_PROFILE_ENUMERATE_INFO_HTC = 1000319000,
...
typedef XrResult (XRAPI_PTR *PFN_xrEnumeratePathsForInteractionProfileHTC)(XrInstance instance, const XrPathsForInteractionProfileEnumerateInfoHTC* enumerateInfo, uint32_t pathCapacityInput, uint32_t* pathCountOutput, XrPath* paths);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrEnumeratePathsForInteractionProfileHTC(
    XrInstance                                  instance,
    const XrPathsForInteractionProfileEnumerateInfoHTC* enumerateInfo,
    uint32_t                                    pathCapacityInput,
    uint32_t*                                   pathCountOutput,
    XrPath*                                     paths);
#endif /* XR_EXTENSION_PROTOTYPES */
