...
#define XR_LIST_ENUM_XrStructureType(_) \
    ...
    _(XR_TYPE_PATHS_FOR_INTERACTION_PROFILE_ENUMERATE_INFO_HTC, 1000319000) \
...
/// Calls your macro with the name of each member of XrPathsForInteractionProfileEnumerateInfoHTC, in order.
#define XR_LIST_STRUCT_XrPathsForInteractionProfileEnumerateInfoHTC(_) \
    _(type) \
    _(next) \
    _(interactionProfile) \
    _(userPath) \
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
    ...
    _(XrPathsForInteractionProfileEnumerateInfoHTC, XR_TYPE_PATHS_FOR_INTERACTION_PROFILE_ENUMERATE_INFO_HTC) \
...
#define XR_LIST_EXTENSIONS(_) \
    ...
    _(XR_HTC_path_enumeration, 320) \
    _(XR_HTC_vive_xr_tracker_interaction, 321) \
