...
#define XR_LIST_ENUM_XrStructureType(_) \
    ...
    _(XR_TYPE_EYE_TRACKER_CREATE_INFO_HTC, 1000326001) \
    _(XR_TYPE_EYE_GAZES_INFO_HTC, 1000326002) \
    _(XR_TYPE_EYE_GAZES_HTC, 1000326003) \
    _(XR_TYPE_EYE_GAZE_HTC, 1000326004) \
    _(XR_TYPE_SYSTEM_EYE_TRACKING_PROPERTIES_HTC, 1000326005) \
    _(XR_TYPE_PUPIL_DATAS_INFO_HTC, 1000326006) \
    _(XR_TYPE_PUPIL_DATAS_HTC, 1000326007) \
    _(XR_TYPE_PUPIL_DATA_HTC, 1000326008) \
    _(XR_TYPE_EYE_GEOMETRIC_DATAS_INFO_HTC, 1000326009) \
    _(XR_TYPE_EYE_GEOMETRIC_DATAS_HTC, 1000326010) \
    _(XR_TYPE_EYE_GEOMETRIC_DATA_HTC, 1000326011) \
...
#define XR_LIST_ENUM_XrObjectType(_) \
    ...
    _(XR_OBJECT_TYPE_EYE_TRACKER_HTC, 1000326000) \
...
#define XR_LIST_ENUM_XrEyePositionHTC(_) \
    _(XR_EYE_POSITION_LEFT_HTC, 0) \
    _(XR_EYE_POSITION_RIGHT_HTC, 1) \
    _(XR_EYE_POSITION_COUNT_HTC, 2) \
    _(XR_EYE_POSITION_MAX_ENUM_HTC, 0x7FFFFFFF)
...
/// Calls your macro with the name of each member of XrEyeGazeHTC, in order.
#define XR_LIST_STRUCT_XrEyeGazeHTC(_) \
    _(isValid) \
    _(gazePose) \

/// Calls your macro with the name of each member of XrEyeTrackerCreateInfoHTC, in order.
#define XR_LIST_STRUCT_XrEyeTrackerCreateInfoHTC(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrEyeGazesInfoHTC, in order.
#define XR_LIST_STRUCT_XrEyeGazesInfoHTC(_) \
    _(type) \
    _(next) \
    _(baseSpace) \
    _(time) \

/// Calls your macro with the name of each member of XrSystemEyeTrackingPropertiesHTC, in order.
#define XR_LIST_STRUCT_XrSystemEyeTrackingPropertiesHTC(_) \
    _(type) \
    _(next) \
    _(supportsEyeTracking) \

/// Calls your macro with the name of each member of XrEyeGazesHTC, in order.
#define XR_LIST_STRUCT_XrEyeGazesHTC(_) \
    _(type) \
    _(next) \
    _(gaze) \
    _(time) \

/// Calls your macro with the name of each member of XrPupilDatasInfoHTC, in order.
#define XR_LIST_STRUCT_XrPupilDatasInfoHTC(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrPupilDataHTC, in order.
#define XR_LIST_STRUCT_XrPupilDataHTC(_) \
    _(isDiameterValid) \
    _(isPositionValid) \
    _(pupilDiameter) \
    _(pupilPosition) \

/// Calls your macro with the name of each member of XrPupilDatasHTC, in order.
#define XR_LIST_STRUCT_XrPupilDatasHTC(_) \
    _(type) \
    _(next) \
    _(time) \
    _(pupilData) \

/// Calls your macro with the name of each member of XrEyeGeometricDatasInfoHTC, in order.
#define XR_LIST_STRUCT_XrEyeGeometricDatasInfoHTC(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrEyeGeometricDataHTC, in order.
#define XR_LIST_STRUCT_XrEyeGeometricDataHTC(_) \
    _(isValid) \
    _(eyeOpenness) \
    _(eyeWide) \
    _(eyeSqueeze) \

/// Calls your macro with the name of each member of XrEyeGeometricDatasHTC, in order.
#define XR_LIST_STRUCT_XrEyeGeometricDatasHTC(_) \
    _(type) \
    _(next) \
    _(eyeGeometricData) \
    _(time) \
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
    ...
    _(XrEyeTrackerCreateInfoHTC, XR_TYPE_EYE_TRACKER_CREATE_INFO_HTC) \
    _(XrEyeGazesInfoHTC, XR_TYPE_EYE_GAZES_INFO_HTC) \
    _(XrSystemEyeTrackingPropertiesHTC, XR_TYPE_SYSTEM_EYE_TRACKING_PROPERTIES_HTC) \
    _(XrEyeGazesHTC, XR_TYPE_EYE_GAZES_HTC) \
    _(XrPupilDatasInfoHTC, XR_TYPE_PUPIL_DATAS_INFO_HTC) \
    _(XrPupilDatasHTC, XR_TYPE_PUPIL_DATAS_HTC) \
    _(XrEyeGeometricDatasInfoHTC, XR_TYPE_EYE_GEOMETRIC_DATAS_INFO_HTC) \
    _(XrEyeGeometricDatasHTC, XR_TYPE_EYE_GEOMETRIC_DATAS_HTC) \
...
/// For every function defined by XR_HTC_eye_tracker in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_HTC_eye_tracker(_) \
    _(CreateEyeTrackerHTC, HTC_eye_tracker) \
    _(DestroyEyeTrackerHTC, HTC_eye_tracker) \
    _(GetEyeGazesHTC, HTC_eye_tracker) \
    _(GetPupilDatasHTC, HTC_eye_tracker) \
    _(GetEyeGeometricDatasHTC, HTC_eye_tracker) \
