...
typedef enum XrObjectType {
    ...
    XR_OBJECT_TYPE_EYE_TRACKER_HTC = 1000326000,
...
// XR_HTC_eye_tracker is a preprocessor guard. Do not pass it to API calls.
#define XR_HTC_eye_tracker 1
XR_DEFINE_HANDLE(XrEyeTrackerHTC)
#define XR_HTC_eye_tracker_SPEC_VERSION   1
#define XR_HTC_EYE_TRACKER_EXTENSION_NAME "XR_HTC_eye_tracker"

typedef enum XrEyePositionHTC {
    XR_EYE_POSITION_LEFT_HTC = 0,
    XR_EYE_POSITION_RIGHT_HTC = 1,
    XR_EYE_POSITION_COUNT_HTC = 2,
    XR_EYE_POSITION_MAX_ENUM_HTC = 0x7FFFFFFF
} XrEyePositionHTC;
typedef struct XrSingleEyeGazeDataHTC {
    XrBool32    isValid;
    XrPosef     gazePose;
} XrSingleEyeGazeDataHTC;

typedef struct XrEyeTrackerCreateInfoHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrEyeTrackerCreateInfoHTC;

typedef struct XrEyeGazeDataInfoHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrSpace                     baseSpace;
    XrTime                      time;
...
// XrSystemEyeTrackingPropertiesHTC extends XrSystemProperties
typedef struct XrSystemEyeTrackingPropertiesHTC {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrBool32              supportsEyeTracking;
} XrSystemEyeTrackingPropertiesHTC;

typedef struct XrEyeGazeDataHTC {
    XrStructureType           type;
    void* XR_MAY_ALIAS        next;
    XrTime                    time;
    XrSingleEyeGazeDataHTC    gazes[XR_EYE_POSITION_COUNT_HTC];
} XrEyeGazeDataHTC;

typedef struct XrEyePupilDataInfoHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrEyePupilDataInfoHTC;

typedef struct XrSingleEyePupilDataHTC {
    XrBool32      isDiameterValid;
    XrBool32      isPositionValid;
    float         pupilDiameter;
    XrVector2f    pupilPosition;
} XrSingleEyePupilDataHTC;

typedef struct XrEyePupilDataHTC {
    XrStructureType            type;
    void* XR_MAY_ALIAS         next;
    XrTime                     time;
    XrSingleEyePupilDataHTC    pupils[XR_EYE_POSITION_COUNT_HTC];
} XrEyePupilDataHTC;

typedef struct XrEyeGeometricDataInfoHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrEyeGeometricDataInfoHTC;

typedef struct XrSingleEyeGeometricDataHTC {
    XrBool32    isValid;
    float       eyeOpenness;
    float       eyeWide;
    float       eyeSqueeze;
...
typedef struct XrEyeGeometricDataHTC {
    XrStructureType                type;
    void* XR_MAY_ALIAS             next;
    XrTime                         time;
    XrSingleEyeGeometricDataHTC    geometrics[XR_EYE_POSITION_COUNT_HTC];
} XrEyeGeometricDataHTC;

typedef XrResult (XRAPI_PTR *PFN_xrCreateEyeTrackerHTC)(XrSession session, const XrEyeTrackerCreateInfoHTC* createInfo, XrEyeTrackerHTC* eyeTracker);
typedef XrResult (XRAPI_PTR *PFN_xrDestroyEyeTrackerHTC)(XrEyeTrackerHTC eyeTracker);
typedef XrResult (XRAPI_PTR *PFN_xrGetEyeGazeDataHTC)(XrEyeTrackerHTC eyeTracker, const XrEyeGazeDataInfoHTC* gazeDataInfo, XrEyeGazeDataHTC* gazeData);
typedef XrResult (XRAPI_PTR *PFN_xrGetEyePupilDataHTC)(XrEyeTrackerHTC eyeTracker, const XrEyePupilDataInfoHTC* pupilDataInfo, XrEyePupilDataHTC* pupilData);
typedef XrResult (XRAPI_PTR *PFN_xrGetEyeGeometricDataHTC)(XrEyeTrackerHTC eyeTracker, const XrEyeGeometricDataInfoHTC* geometricDataInfo, XrEyeGeometricDataHTC* geometricData);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrCreateEyeTrackerHTC(
    XrSession                                   session,
    const XrEyeTrackerCreateInfoHTC*            createInfo,
    XrEyeTrackerHTC*                            eyeTracker);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroyEyeTrackerHTC(
    XrEyeTrackerHTC                             eyeTracker);

XRAPI_ATTR XrResult XRAPI_CALL xrGetEyeGazeDataHTC(
    XrEyeTrackerHTC                             eyeTracker,
    const XrEyeGazeDataInfoHTC*                 gazeDataInfo,
    XrEyeGazeDataHTC*                           gazeData);

XRAPI_ATTR XrResult XRAPI_CALL xrGetEyePupilDataHTC(
    XrEyeTrackerHTC                             eyeTracker,
    const XrEyePupilDataInfoHTC*                pupilDataInfo,
    XrEyePupilDataHTC*                          pupilData);

XRAPI_ATTR XrResult XRAPI_CALL xrGetEyeGeometricDataHTC(
    XrEyeTrackerHTC                             eyeTracker,
    const XrEyeGeometricDataInfoHTC*            geometricDataInfo,
    XrEyeGeometricDataHTC*                      geometricData);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
