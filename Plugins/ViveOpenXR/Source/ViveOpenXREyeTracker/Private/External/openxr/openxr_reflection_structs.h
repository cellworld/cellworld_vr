...
#define _impl_XR_LIST_ALL_STRUCTURE_TYPES_CORE(_avail, _unavail) \
    ...
    _avail(XrEyeTrackerCreateInfoHTC, XR_TYPE_EYE_TRACKER_CREATE_INFO_HTC) \
    _avail(XrEyeGazesInfoHTC, XR_TYPE_EYE_GAZES_INFO_HTC) \
    _avail(XrSystemEyeTrackingPropertiesHTC, XR_TYPE_SYSTEM_EYE_TRACKING_PROPERTIES_HTC) \
    _avail(XrEyeGazesHTC, XR_TYPE_EYE_GAZES_HTC) \
    _avail(XrPupilDatasInfoHTC, XR_TYPE_PUPIL_DATAS_INFO_HTC) \
    _avail(XrPupilDatasHTC, XR_TYPE_PUPIL_DATAS_HTC) \
    _avail(XrEyeGeometricDatasInfoHTC, XR_TYPE_EYE_GEOMETRIC_DATAS_INFO_HTC) \
    _avail(XrEyeGeometricDatasHTC, XR_TYPE_EYE_GEOMETRIC_DATAS_HTC) \
